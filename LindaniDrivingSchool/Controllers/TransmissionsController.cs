...
namespace LindaniDrivingSchool.Controllers
{
    public class TransmissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransmissionId,TransmissionType")] Transmission transmission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransmissionId,TransmissionType")] Transmission transmission)
        {
            if (ModelState.IsValid)
            {
