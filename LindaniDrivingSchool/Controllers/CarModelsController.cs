...
namespace LindaniDrivingSchool.Controllers
{
    public class CarModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarModelId,CarModelType")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarModelId,CarModelType")] CarModel carModel)
        {
            if (ModelState.IsValid)
            {
