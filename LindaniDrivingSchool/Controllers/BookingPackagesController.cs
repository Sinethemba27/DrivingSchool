...
namespace LindaniDrivingSchool.Controllers
{
    public class BookingPackagesController : Controller
    {
        ...
        {
            ViewBag.BookingTypeId = new SelectList(db.BookingTypes, "BookingTypeId", "BktName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "BokingPackageId,BookingTypeId,Descrition,IncludeExtra,PackagePrice")] BookingPackage bookingPackage)
        {
            ...
            ViewBag.BookingTypeId = new SelectList(db.BookingTypes, "BookingTypeId", "BktName", bookingPackage.BookingTypeId);
            return View(bookingPackage);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BokingPackageId,BookingTypeId,Descrition,IncludeExtra,PackagePrice")] BookingPackage bookingPackage)
        {
            if (ModelState.IsValid)
            {
