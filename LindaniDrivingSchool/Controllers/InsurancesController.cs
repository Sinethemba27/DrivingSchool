...
namespace LindaniDrivingSchool.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InsuranceId,InsuranceType,InsuranceFee")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InsuranceId,InsuranceType,InsuranceFee")] Insurance insurance)
        {
            if (ModelState.IsValid)
            {
